...
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     Fahirafiaanstasya 'MRLINKERRORSYSTEM'
    Name       OSIF 'Open Source Information Facebook'
    CodeName   MRLINKERRORSYSTEM
    version    full version
    Date       24/07/2019 04:30 PM
    Team       TEAM HACKER INDONESIA ARMY
    Email      Mrlinkerrorsystem@Progammer.net
    Whatsapps  081249281195 Admin Team 😍
